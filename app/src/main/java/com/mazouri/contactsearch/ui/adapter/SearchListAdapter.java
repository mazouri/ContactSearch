...
public class SearchListAdapter extends RecyclerView.Adapter<SearchListAdapter.ItemVH> {
    ...
    public void updateContactList(ArrayList<ContactBean> contactList) {
    ...
    @Override
    public SearchListAdapter.ItemVH onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_contact_item, parent, false);
        return new SearchListAdapter.ItemVH(view);
    }

    @Override
    public void onBindViewHolder(SearchListAdapter.ItemVH holder, int position) {
